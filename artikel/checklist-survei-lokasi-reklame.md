---
article_id: RKL-02-02
title: "Checklist Survei Lokasi Sebelum Membuat Reklame"
slug: "checklist-survei-lokasi-reklame"
...
date_modified: null
parent_topic: RKL-02
primary_intent: "Capture site facts needed before design and quotation."
reader_community: "Bengkel-las.co.id"
reader_address: "Sobat Bengkel-las.co.id"
final_route: "/artikel/checklist-survei-lokasi-reklame.html"
...
# Checklist Survei Lokasi Sebelum Membuat Reklame

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Checklist Survei Lokasi Sebelum Membuat Reklame”
...
- **Primary intent:** Capture site facts needed before design and quotation.
...
- **Scope boundary:** Pre-design data collection only; installation method and hazards belong to RKL-14.
- **Final public route:** `/artikel/checklist-survei-lokasi-reklame.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Checklist Survei Lokasi Sebelum Membuat Reklame**.
...
- `RKL-02-01` → `/artikel/cara-menulis-brief-signage.html` — Cara Menulis Brief Signage yang Bisa Diproduksi
- `RKL-02-03` → `/artikel/menghitung-jarak-pandang-signage.html` — Menghitung Jarak Pandang dan Waktu Paparan Signage
- `RKL-02-04` → `/artikel/menentukan-audiens-pesan-reklame.html` — Menentukan Audiens, Pesan, dan Aksi Utama pada Reklame
...
- **Tie back to this article:** Keep the explanation specific to “Checklist Survei Lokasi Sebelum Membuat Reklame”.
