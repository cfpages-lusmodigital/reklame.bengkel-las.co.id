---
article_id: RKL-13-06
title: "Audit Kepatuhan Reklame Sebelum Kampanye Dimulai"
slug: "audit-kepatuhan-reklame"
...
date_modified: null
parent_topic: RKL-13
primary_intent: "Verify documents, site approval, structure evidence, tax status, and display scope."
reader_community: "Bengkel-las.co.id"
reader_address: "Sobat Bengkel-las.co.id"
final_route: "/artikel/audit-kepatuhan-reklame.html"
...
# Audit Kepatuhan Reklame Sebelum Kampanye Dimulai

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Audit Kepatuhan Reklame Sebelum Kampanye Dimulai”
...
- **Primary intent:** Verify documents, site approval, structure evidence, tax status, and display scope.
...
- **Scope boundary:** Owns pre-campaign compliance check; installation acceptance belongs to RKL-14.
- **Final public route:** `/artikel/audit-kepatuhan-reklame.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Audit Kepatuhan Reklame Sebelum Kampanye Dimulai**.
...
- **Tie back to this article:** Keep the explanation specific to “Audit Kepatuhan Reklame Sebelum Kampanye Dimulai”.
