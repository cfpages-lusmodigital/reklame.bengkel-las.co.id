---
article_id: RKL-03-03
title: "Memilih Font untuk Papan Nama dan Wayfinding"
slug: "memilih-font-untuk-signage"
...
date_modified: null
parent_topic: RKL-03
primary_intent: "Select type characteristics that support fast recognition."
reader_community: "Bengkel-las.co.id"
reader_address: "Kawan Bengkel-las.co.id"
final_route: "/artikel/memilih-font-untuk-signage.html"
...
# Memilih Font untuk Papan Nama dan Wayfinding

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Memilih Font untuk Papan Nama dan Wayfinding”
...
- **Primary intent:** Select type characteristics that support fast recognition.
...
- **Scope boundary:** Owns typeface selection; directional information hierarchy belongs to RKL-10.
- **Final public route:** `/artikel/memilih-font-untuk-signage.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memilih Font untuk Papan Nama dan Wayfinding**.
...
- **Exact Markdown to insert:** `![Ilustrasi papan nama](/wp-content/uploads/2024/05/papan-nama.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `papan nama` as relevant content media; no pixels were inspected.
...
- `RKL-03-01` → `/artikel/ukuran-huruf-berdasarkan-jarak-baca.html` — Menentukan Ukuran Huruf Berdasarkan Jarak Baca
- `RKL-03-02` → `/artikel/kontras-warna-signage.html` — Kontras Warna Signage agar Terbaca Siang dan Malam
- `RKL-03-04` → `/artikel/menyederhanakan-logo-untuk-fabrikasi.html` — Menyederhanakan Logo agar Siap Difabrikasi
- `RKL-03-05` → `/artikel/hierarki-pesan-pada-reklame.html` — Hierarki Pesan pada Reklame: Apa yang Harus Terbaca Dulu
...
- **Tie back to this article:** Keep the explanation specific to “Memilih Font untuk Papan Nama dan Wayfinding”.
